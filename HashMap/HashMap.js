...
If we have a big enough bucket, we won’t have collisions; thus, the search time would be O(1). 
However, how do we know how big a hash map capacity should big? 100? 1,000? A million?
Having allocated massive amounts of memory is impractical. 
So, we can automatically have the hash map resize itself based on a load factor. 
...
class HashMap {
    ...
    _getBucketIndex(key) {
        ...
        // hash('dog') => 3788563007; bucketIndex => 3788563007 % 3 = 1
        // hash('rat') => 3789411405; bucketIndex => 3789411405 % 3 = 2
        // hash('dog') => 3788563007; bucketIndex => 3788563007 % 2 = 0
